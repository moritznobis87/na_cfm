...
\renewcommand{\maketitle}{%
  \begin{titlepage}
    \thispagestyle{empty}
    \vspace*{15mm}
    \IfFileExists{../../assets/valyze_logo.png}{\includegraphics[height=16mm]{../../assets/valyze_logo.png}}{\sffamily\bfseries\fontsize{16}{20}\selectfont\color{Brand}VALYZE}\par
    \vspace{10mm}
