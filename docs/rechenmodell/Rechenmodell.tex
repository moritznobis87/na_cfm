...
\renewcommand{\maketitle}{%
  \begin{titlepage}
    \thispagestyle{empty}
    \vspace*{15mm}
    \IfFileExists{../../assets/valyze_wortmarke.png}{\includegraphics[height=16mm]{../../assets/valyze_wortmarke.png}}{\sffamily\bfseries\fontsize{16}{20}\selectfont\color{Brand}VALYZE}\par
    \vspace{10mm}
...
Alle Kategorien werden als \textbf{Gesamtbeträge in Euro} erfasst, nicht
...
\textbf{Ausgang.} \(\phi_t\) und \(E_t\) (kWh) je Betriebsjahr.
...
\hypertarget{standard-betriebskostenpositionen}{%
\subsection{8.2
Standard-Betriebskostenpositionen}\label{standard-betriebskostenpositionen}}
...
Modus \textbf{relativ zum Marktwert} -- Anteil \(\varphi\) am nominalen
Jahresmarktwert der erzeugten Menge:

\[ C^{\mathrm{dv}}_t = E_t \cdot \frac{m_t}{100} \cdot \varphi \]

Im relativen Modus verändern sich die Kosten proportional zum
Preisniveau. Eine zusätzliche Kostenindexierung erfolgt nicht, da die
Preisentwicklung bereits im nominalen Marktwert enthalten ist und
...
Für jeden der sieben Treiber wird die EK-Rendite bei
